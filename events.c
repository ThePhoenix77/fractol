...
int			mouse_press(int button, int x, int y, t_fractol *t)
{
...
void		key_press2(int keycode, t_fractol *t)
{
	if (keycode == 124)
	{
...
int			key_press(int keycode, t_fractol *t)
{
	if (keycode == 53)
	{
		destroy_exit(t);
...
void		key_press3(int keycode, t_fractol *t)
{
	if (keycode == 83)
	{
		t->name = "julia";
...
void		key_press4(int keycode, t_fractol *t)
{
	if (keycode == 84)
	{
		t->name = "Burningship";
